...
"""
    ...
    def generate_auto_conf(self):
        ...
        conf_lines = [
            ...
            "#define CONFIG_CC_HAS_KASAN_ABI_TAG 1",
            "#define CONFIG_CC_HAS_KASAN_GLOBAL_QUARANTINE 1",
            "#define CONFIG_CC_HAS_ASM_GOTO_OUTPUT_CONST 1",
            "#define CONFIG_GCC_ASM_GOTO_OUTPUT_CONST 1",
...
"""
    ...
    def fix_preempt_thread_info(self):
        ...
        if needs_patch:
            ...
            # Insert comprehensive CONFIG definitions + thread_info.h include + current_thread_info stub
            patch_lines = [
                "#ifndef CONFIG_HZ",
                "#define CONFIG_HZ 250",
                "#endif",
                ...
                "#ifndef _CURRENT_THREAD_INFO_DEFINED",
                "#define _CURRENT_THREAD_INFO_DEFINED",
