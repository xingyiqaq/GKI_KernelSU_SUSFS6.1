...
"""
    ...
    def setup_repo_tool(self):
        ...
        # GitHub Actions 环境可能没有 pip，直接下载 Google repo 脚本
        import subprocess
        import urllib.request
        repo_path = "/tmp/repo"
        try:
            with urllib.request.urlopen("https://gerrit.googlesource.com/git-repo/+archive/main/repo",
                                        timeout=30) as resp:
                content = resp.read()
